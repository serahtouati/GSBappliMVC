...
// entete d'un comptable
                ...
                <div class="row vertical-align">
                    ...
                    <div class="col-md-8">
                        <ul class="nav nav-pills pull-right" role="tablist">
                            <li  style="color:coral"><?php if (!$uc || $uc == 'accueil') { ?><?php } ?>
                                <a style="color: coral" href="index.php">
                                    Accueil
                                </a>
                            </li>
                            <li <?php if ($uc == 'validerFicheFrais') { ?>class="active"<?php } ?>>
                                <a style="color: coral"href="index.php?uc=validerFicheFrais&action=selectionnerUtilisateur">
                            ...
                            <li
                            <?php if ($uc == 'deconnexion') { ?>class="active"<?php } ?>>
                                <a style="color: coral" href="index.php?uc=deconnexion&action=demandeDeconnexion">
                                    <span class="glyphicon glyphicon-log-out"></span>
                                    Déconnexion
                                </a>
                            </li>
